...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/unrar-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14314&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/unrar-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `unrar` can be installed with:

```
conda install unrar
```

It is possible to list all of the versions of `unrar` available on your platform with:
